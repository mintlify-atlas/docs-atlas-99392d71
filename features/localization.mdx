...
An Anime Game Launcher supports 20 languages with full localization powered by the Fluent localization system. The launcher automatically detects your system language and provides seamless translation for all UI elements.
...
<AccordionGroup>
  ...
  <Accordion title="Eastern European Languages (3)">
  ...
  <Accordion title="Asian Languages (6)">
  ...
  <Accordion title="Other Languages (2)">
    - **Turkish** - `tr-tr` (Türkçe)
  </Accordion>
</AccordionGroup>

**Total:** 20 supported languages
